...
const PrivacyPolicy = () => {
  ...
  return (
    <div className="py-24 bg-white/5 backdrop-blur-md min-h-screen">
      <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
        
        {/* Header */}
        <div className="mb-16">
          <div className="bg-slate-900 px-6 py-2 inline-block mb-6 shadow-[8px_8px_0px_0px_rgba(57,255,20,1)] transform -rotate-1">
            <span className="font-black uppercase tracking-widest text-2xl text-white">Legal & Privacy</span>
          </div>
          <h1 className="brutal-heading-lg text-slate-200 mb-8 border-b border-white/10 pb-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-16">
          {policies.map((policy, index) => {
            ...
            return (
              <div 
                key={index} 
                className={`p-8 border border-white/10 shadow-[8px_8px_0px_0px_rgba(0,0,0,1)] hover:-translate-y-2 hover:shadow-[12px_12px_0px_0px_rgba(0,0,0,1)] transition-all ${policy.color}`}
              >
                <div className="flex items-center gap-4 mb-6">
                  <div className="p-3 bg-white/5 backdrop-blur-md border border-white/10 text-slate-200 inline-block">
        ...
        {/* Footer Note */}
        <div className="bg-gray-100 p-8 border border-white/10 border-dashed text-center">
