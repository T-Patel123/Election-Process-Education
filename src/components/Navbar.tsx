...
const Navbar = () => {
  return (
    <nav className="sticky top-0 z-50 bg-white/5 backdrop-blur-md border-b-4 border-white/10">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between h-20 items-center">
          <a href="#" className="flex items-center gap-2 group cursor-pointer">
            <div className="bg-indigo-600 p-2 border border-white/10 shadow-glass group-hover:translate-x-[2px] group-hover:translate-y-[2px] group-hover:shadow-none transition-all">
