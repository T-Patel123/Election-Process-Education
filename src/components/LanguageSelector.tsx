      ...
      {isOpen && (
        ...
        >
          <motion.div
            ...
            className="bg-white/5 backdrop-blur-md border border-white/10 max-w-4xl w-full p-8 md:p-12 shadow-[16px_16px_0px_0px_rgba(0,0,0,1)] max-h-[90vh] flex flex-col"
          >
            <div className="flex flex-col items-center mb-8 md:mb-12 text-center">
              <div className="bg-cyan-500 p-4 border border-white/10 mb-6 transform -rotate-3 shadow-premium">
                <Globe size={48} />
              </div>
            ...
            <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4 overflow-y-auto custom-scrollbar p-2">
              {languages.map((lang) => (
                <button
                  ...
                  className="group relative bg-gray-100 border border-white/10 p-4 text-left transition-all hover:-translate-y-2 hover:-translate-x-2 hover:shadow-[8px_8px_0px_0px_rgba(0,0,0,1)] hover:bg-indigo-600 focus:outline-none"
                >
