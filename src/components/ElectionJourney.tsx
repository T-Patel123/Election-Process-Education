...
const ElectionJourney = () => {
  ...
  return (
    <section id="journey" className="py-24 bg-white/5 backdrop-blur-md border-b border-white/10 overflow-hidden">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {steps.map((step, index) => (
            <motion.div
              ...
              className="brutal-card cursor-pointer group flex flex-col gap-4 hover:bg-slate-900 hover:text-white transition-colors"
            >
              <div className={`w-16 h-16 ${step.color} border border-white/10 flex items-center justify-center text-white shadow-premium group-hover:shadow-none transition-all`}>
        ...
        {selectedStep && (
          ...
          >
            <motion.div
              ...
              animate={{ scale: 1, y: 0 }}
              exit={{ scale: 0.9, y: 50 }}
              className="brutal-card max-w-2xl w-full relative bg-white/5 backdrop-blur-md"
            >
              <button 
                onClick={() => setSelectedStep(null)}
                aria-label="Close Step Details"
                className="absolute top-4 right-4 p-2 border border-white/10 hover:bg-pink-600 hover:text-white transition-colors"
              >
                <X size={24} />
              </button>

              <div className="flex items-center gap-4 mb-6">
                <div className={`w-16 h-16 ${selectedStep.color} border border-white/10 flex items-center justify-center text-white shadow-premium`}>
              ...
              <div className="space-y-6">
                ...
                <div className="bg-slate-900 text-white p-6 border border-white/10">
